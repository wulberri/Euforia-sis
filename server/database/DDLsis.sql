...
/*  Created On : 21-nov.-2023 7:05:32 p. m. 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
ALTER TABLE `Auditorio` 
 ADD INDEX `IXFK_Auditorio_Recurso_02` (`pk_fk_id_recurso` ASC, `pk_fk_num_unidad` ASC)
;
...
ALTER TABLE `Aula` 
 ADD INDEX `IXFK_Aula_Recurso_02` (`pk_fk_id_recurso` ASC, `pk_fk_num_unidad` ASC)
;
...
ALTER TABLE `Horario_Recurso` 
 ADD INDEX `IXFK_Horario - Copy_Recurso_02` (`fk_id_recurso` ASC, `fk_num_unidad` ASC)
;
...
ALTER TABLE `Patio` 
 ADD INDEX `IXFK_Patio_Recurso_02` (`pk_fk_id_recurso` ASC, `pk_fk_num_unidad` ASC)
;
...
ALTER TABLE `Auditorio` 
 ADD CONSTRAINT `FK_Auditorio_Recurso`
	FOREIGN KEY (`pk_fk_id_recurso`, `pk_fk_num_unidad`) REFERENCES `Recurso` (`pk_id_recurso`,`pk_fk_num_unidad`) ON DELETE Cascade ON UPDATE Cascade
;
...
ALTER TABLE `Horario_Recurso` 
 ADD CONSTRAINT `FK_Horario - Copy_Recurso`
	FOREIGN KEY (`fk_id_recurso`, `fk_num_unidad`) REFERENCES `Recurso` (`pk_id_recurso`,`pk_fk_num_unidad`) ON DELETE Cascade ON UPDATE Cascade
;
...
ALTER TABLE `Prestamo` 
 ADD CONSTRAINT `FK_Prestamo_Reserva`
	FOREIGN KEY (`fk_id_reserva`) REFERENCES `Reserva` (`id_reserva`) ON DELETE Cascade ON UPDATE Cascade
;
